...
class Boggle:    
    ...
    def __init__(self, boardstr, dictionary=None):
    ...
    def load_dict(self, dictFile, min_len=3):
        f = open(dictFile)
        self.dict = []
...
@click.option('-l', '--minimum_length', type=int, default=3, help='only return words longer than this')
